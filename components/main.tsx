...
export const Main: NextPage<Props> = ({ menus }) => {
  ...
  const handleButton = async () => {
    setLoading(true);
    const filteredMenus = isExtractAlcohol ? menus.filter((menu) => menu.name_en !== 'Alcohol') : menus;
          ...
          <MainContent isResult={isResult}>
            ...
            <ButtonArea isResult={isResult} isButtonAreaFloat={isButtonAreaFloat}>
              <ButtonAreaContainer>
                ...
                />
                <FooterLink>
                  <a href="https://shop.saizeriya.co.jp/sz_restaurant/" target="_blank" rel="noopener noreferrer">
                    店舗検索 (公式)
                  </a>
                  <br />
                  <Link href="/about">このサイトについて</Link>
                  {' / '}
                  <a href="https://twitter.com/saizeriyagacha" target="_blank" rel="noopener noreferrer">
                    Twitter
                  </a>
                </FooterLink>
              </ButtonAreaContainer>
